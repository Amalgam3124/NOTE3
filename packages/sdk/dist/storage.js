...
export async function saveNote(title, content, signer, options = {}) {
    try {
        if (!signer) {
...
export async function loadNote(cid, signer) {
    try {
        if (!signer) {
            throw new Error('Wallet not connected');
        }
...
export async function getJSON(cid, signer) {
    try {
        if (!signer) {
            throw new Error('Wallet not connected');
        }
        ...
        try {
            ...
            const storageNodes = locations.map((location) => new StorageNode(location.url));
...
export async function putFile(file, signer) {
    try {
        if (!signer) {
            throw new Error('Wallet not connected');
        }
...
export async function getFile(cid, signer) {
    try {
        if (!signer) {
            throw new Error('Wallet not connected');
        }
